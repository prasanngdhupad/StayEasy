...
import { register, removeSuccess } from '../features/user/userSlice.js'
...
function Register() {
    ...
    const [avatarPreview,setAvatarPreview]=useState('./images/product.png')
            ...
            <div className="form-content">
                <form className="form" onSubmit={registerSubmit} encType='multipart/form-data'>
                    ...
                    <div className='input-group avatar-group'>
                        <input type="file" className='file-input' accept='image/' name='avatar' onChange={registerDataChange}/>
